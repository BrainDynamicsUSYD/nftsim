...
Duplicated code, with subtle variations between them, is one of the best ways to introduce unintended results. \underline{Code reuse} should be a high priority.
