...
available at \url{http://physics.usyd.edu.au/brain/neurofield} %under the GNU license 
...
%	Wrapper& MATLAB scripts & Python scripts & Create and run config files \\
%	& \multicolumn{2}{c}{Config file} & Specifies all simulation information \\
%	Simulation & \multicolumn{2}{c}{NeuroField} & Simulation program \\
%	& \multicolumn{2}{c}{Output file} & Contains simulated time series \\
%\end{tabular}
