...
\journal{J. Neurosci. Methods (any others?)}
...
\begin{abstract}
%% Text of abstract
Draft on publication of NeuroField to document capability, usage, and example results. Other internal documents exist: a user manual and a developer manual.

\end{abstract}

\begin{keyword}
%% keywords here, in the form: keyword \sep keyword
Neural field theory \sep EEG \sep neurophysiology \sep methods \sep modeling
...
%Background about the problem being solved, mention of other existing solutions, motivate the code and brief overview of features

Motivation behind neural field theory: large-scale neural dynamics.

Neural field theory of Robinson et al, EEG spectra, alpha and beta peaks, etc:
...
%Dotpoint form going over key features of the code, with screenshots 
...
\end{align*}
where an arbitrary number of these objects, with each object may be a different type (e.g. constant synaptic coupling vs plastic synaptic coupling), and all parameter values may be tailored.
...
Overview of any tricky issues with the problem being solved e.g. EEGLAB mentiones limitations of time/frequency decompsition. Discuss limitations or qualifiers on the usage of the code.
