...
\todo[inline]{Do we have a derivation or something for the actual stencil equation?}
...
Following the connection matrix is a detailed specification for each population. The spatial grid resolution is determined based on the 
