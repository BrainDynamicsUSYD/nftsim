...
\begin{itemize}
\item Background information about neural field theory, the problem being solved, alternative approaches etc.
\item Present model equations, motivate usage of the code
\item Brief overview of key code features e.g. arbitrary populations and connections, plasticity etc. 
\end{itemize}

\section{Method and Results}
\label{sec:theory}

Dotpoint form going over key features of the code, with screenshots. Perhaps go through the key components of the model (populations, propagators, couples) and explain each one
...
Then an overview of the key modeling achievements
