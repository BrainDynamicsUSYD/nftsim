...
Couple: 2
	\end{lstlisting}
	Specify objects to output. For \type{Population}, \type{Propag} and \type{Couple}, if you request a nonexistant trace an error will be raised. For \type{Dendrite}, if you request a nonexistant dendrite, there will be no output for this dendrite, and no error or warning is raised. 
