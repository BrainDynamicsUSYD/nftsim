...
syn keyword statement Composite Const White CoherentWhite Pulse Sine Gaussian Ramp GaussPulse PAS Sigmoid Linear Bursting Map Wave Harmonic CaDP BCM STP fCaP Multi Q V phi Tau nu
