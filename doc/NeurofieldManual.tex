...
\item Specify all couplings (Sec.~\ref{sec:coupling}).
...
As discussed at the start of manual, \NF encapsulates each component of the model with an object: \type{Coupling}, \type{Dendrite}, \type{QResponse}, \type{Propagator}. The \type{Dendrite} and \type{QResponse} (and also \type{Timeseries}) are contained within \type{Population}.
...
\begin{tabular}{l l l}
	...
	\type{LongCouple}&\type{Coupling}&Nonlocal synapse.
\end{tabular}
