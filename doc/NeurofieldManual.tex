...
will use the configuration file \type{example.conf} within the \type{configs} folder, and will write output to \type{example.output} also in the \type{configs} folder.
